...
export const COMMANDS_DIR = join(__dirname, "../commands/");
export const COINFLIP_IMG = join(__dirname, "../../assets/coinflip/");
export const DAILY_IMG = join(__dirname, "../../assets/daily/");
export const ROULETTE_IMG = join(__dirname, "../../assets/roulette/");
export const CHIPS_PATH = join(__dirname, "../../db/data.sqlite");
export const CDS_PATH = join(__dirname, "../../db/cooldowns.sqlite");
